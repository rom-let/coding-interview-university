...
1. Mark all boxes with X after you completed your changes:
	a checked box next to an action means it’s done
	a checked box next to a book means it’s bought <!-- (maybe add a second box for "read") -->
    ```bash
...
- [x] [great short overview video of what you will learn](https://m.youtube.com/watch?v=Z_c4byLrNBU)
...
- ### Linked Lists
    ...
    - [x] [Why you should avoid linked lists (video)](https://www.youtube.com/watch?v=YQs6IC-vgmo) <- video turned private, watch [this review of the private video instead](https://www.youtube.com/watch?v=cvZArAipOjo) 
